...
public class ShopcartController {
   ...
   /* @DeleteMapping("/delete/{cid}")
    @ApiImplicitParam(dataType = "int",name = "cid", value = "选择的删除购物车记录的id",required = true)
    public ResultVO deleteById(@PathVariable("cid") int cid){
        ResultVO resultVO = shoppingCartService.deleteById(cid);
        return resultVO;
    }*/
